...
#Getting All Available Page URLs to Crawl
def get_urls():
    urls = []
...
#Parsing Item with Soup (lxml parser make it faster!)
def parser(resp):
    items = []
    for r in resp:
        ...
        for game in all_games:
            ...
            #Some Game Items Doesnt Have any further information except to their names
            try:
...
#Making Connection to a database and inserting crawled data into it!
def db_conn():
